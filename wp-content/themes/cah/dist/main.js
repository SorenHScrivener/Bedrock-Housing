    ...
    events(){
        ...
        if(window.innerWidth < 500){
            this.formField.forEach(f =>{
                ...
                let combined = test + target + (window.innerHeight/2);
